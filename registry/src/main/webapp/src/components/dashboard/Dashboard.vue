<template>
  <div class="ev-dashboard">
    <app-nav class="Home__PageTeller" :title="pageName"
             v-on:TOGGLE_SIDEBAR="toggleSidenav"></app-nav>
    ...
    <app-sidebar ref="sidenav"></app-sidebar>
    ...
    <!--  
          ...
          <div class="card">
            ...
            <div class="card-block">
              ...
              <a href="#" class="btn btn-primary" @click="addressModalVisible = true">Open child modal</a>
              <br>
              <br> The visible status of the modal:
              <code>{{ addressModalVisible }}</code>
              <br>
              <br> The address info:
              <pre>{{ addressInfo }}</pre>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-block">
              ...
              <button class="btn btn-primary" @click="getFriends()">Get friends</button>
              <br>
              <br>
          ...
          <address-modal v-if="addressModalVisible" :visible="true" @saved="addressInfo = arguments[0]" @closed="addressModalVisible = false">
          </address-modal>-->
...
export default {
  name: 'dashboard',
  components: { AppNav, AppSidebar, AppFooter, AddressModal, Spinner },
  data() {
    return {
      addressInfo: {
        addressLine1: '',
