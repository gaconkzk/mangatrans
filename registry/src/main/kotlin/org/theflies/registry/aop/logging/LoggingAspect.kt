package org.theflies.registry.aop.logging
...
class LoggingAspect(private val env: Environment) {
   ...
   */
  @Pointcut("within(org.theflies.registry.repository..*) || within(org.theflies.registry.service..*) || within(org.theflies.registry.web.rest..*)")
  fun loggingPointcut() {
  ...
  fun logAfterThrowing(joinPoint: JoinPoint, e: Throwable) {
    if (env.acceptsProfiles(TheFliesConstants.SPRING_PROFILE_DEVELOPMENT)) {
