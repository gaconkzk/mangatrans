 ...
 * `spring.profiles.active` set in the environment or as command line argument. If the
 * value is not available in `application.yml` then `dev` profile will be used
 * as default.
 */
